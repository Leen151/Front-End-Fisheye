class MediaCard {
	...
	getMediaCardDOM() {
		...
		if (this._media.image) {
			baliseMedia = `<img src="${this._media.image}" alt="photo: ${this._media.title}" class="media-thumbnail">`;
		}else if (this._media.video) {
			baliseMedia = `<video src="${this._media.video}" class="media-thumbnail"></video>`;
		}
		...
		if(baliseMedia){
			...
			<div class="media-infos">
				...
				<div class="likes" data-liked = "false">
					<p class="likes-number" id="${this._media.id}">
						${this._media.likes}
					</p>
